...
Boolean H264or5VideoRTPSink::continuePlaying() {
  ...
  // H264or5Fragmenter 的source  是原来H264or5VideoRTPSink的source 
  // H264or5VideoRTPSink 的source 现在改为 H264or5Fragmenter(-->FramedFilter-->FramedSource)
...
void H264or5Fragmenter::doGetNextFrame() {
  if (fNumValidDataBytes == 1) { // 如果没有NAL了 再从FrameSource获取(e.g ByteStreamFileSource)
